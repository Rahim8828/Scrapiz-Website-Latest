...
const ScrapDealerinVikhroli = ({ openModal }) => {
  const locationData = {
    name: 'Vikhroli',
    address: 'Shop No. 07, Vikhroli, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-vikhroli#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-vikhroli#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-vikhroli#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Vikhroli",
            "item": "https://www.scrapiz.in/scrap-dealer-in-vikhroli"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer vikhroli, scrap buyer vikhroli, kabadiwala vikhroli, sell scrap vikhroli, scrap pickup vikhroli, vikhroli scrap dealer, best scrap rates vikhroli, scrap collection vikhroli" />
