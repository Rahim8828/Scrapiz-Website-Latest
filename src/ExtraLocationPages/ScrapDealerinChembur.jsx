...
const ScrapDealerinChembur = ({ openModal }) => {
  const locationData = {
    name: 'Chembur',
    address: 'Shop No. 07, Chembur, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-chembur#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-chembur#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-chembur#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Chembur",
            "item": "https://www.scrapiz.in/scrap-dealer-in-chembur"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer chembur, scrap buyer chembur, kabadiwala chembur, sell scrap chembur, scrap pickup chembur, chembur scrap dealer, best scrap rates chembur, scrap collection chembur" />
