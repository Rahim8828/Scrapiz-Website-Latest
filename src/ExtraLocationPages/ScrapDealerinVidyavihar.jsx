...
const ScrapDealerinVidyavihar = ({ openModal }) => {
  const locationData = {
    name: 'Vidyavihar',
    address: 'Shop No. 07, Vidyavihar, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-vidyavihar#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-vidyavihar#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-vidyavihar#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Vidyavihar",
            "item": "https://www.scrapiz.in/scrap-dealer-in-vidyavihar"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer vidyavihar, scrap buyer vidyavihar, kabadiwala vidyavihar, sell scrap vidyavihar, scrap pickup vidyavihar, vidyavihar scrap dealer, best scrap rates vidyavihar, scrap collection vidyavihar" />
