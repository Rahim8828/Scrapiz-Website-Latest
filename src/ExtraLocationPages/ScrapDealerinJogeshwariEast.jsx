...
const ScrapDealerinJogeshwariEast = ({ openModal }) => {
  const locationData = {
    ...
    address: 'Shop No. 07, Jogeshwari East, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-jogeshwari-east#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-jogeshwari-east#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-jogeshwari-east#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Jogeshwari East",
            "item": "https://www.scrapiz.in/scrap-dealer-in-jogeshwari-east"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer jogeshwari east, scrap buyer jogeshwari east, kabadiwala jogeshwari east, sell scrap jogeshwari east, scrap pickup jogeshwari east, jogeshwari east scrap dealer, best scrap rates jogeshwari east, scrap collection jogeshwari east" />
