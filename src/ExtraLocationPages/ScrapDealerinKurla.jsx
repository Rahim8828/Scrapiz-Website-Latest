...
const ScrapDealerinKurla = ({ openModal }) => {
  const locationData = {
    name: 'Kurla',
    address: 'Shop No. 07, Kurla, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-kurla#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-kurla#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-kurla#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Kurla",
            "item": "https://www.scrapiz.in/scrap-dealer-in-kurla"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer kurla, scrap buyer kurla, kabadiwala kurla, sell scrap kurla, scrap pickup kurla, kurla scrap dealer, best scrap rates kurla, scrap collection kurla" />
