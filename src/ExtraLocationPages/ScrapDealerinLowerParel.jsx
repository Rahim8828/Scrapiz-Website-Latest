...
const ScrapDealerinLowerParel = ({ openModal }) => {
  const locationData = {
    name: 'Lower Parel',
    address: 'Shop No. 07, Lower Parel, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-lower-parel#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-lower-parel#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-lower-parel#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Lower Parel",
            "item": "https://www.scrapiz.in/scrap-dealer-in-lower-parel"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer lower parel, scrap buyer lower parel, kabadiwala lower parel, sell scrap lower parel, scrap pickup lower parel, lower parel scrap dealer, best scrap rates lower parel, scrap collection lower parel" />
