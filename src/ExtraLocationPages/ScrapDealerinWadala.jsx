...
const ScrapDealerinWadala = ({ openModal }) => {
  const locationData = {
    name: 'Wadala',
    address: 'Shop No. 07, Wadala, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-wadala#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-wadala#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-wadala#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Wadala",
            "item": "https://www.scrapiz.in/scrap-dealer-in-wadala"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer wadala, scrap buyer wadala, kabadiwala wadala, sell scrap wadala, scrap pickup wadala, wadala scrap dealer, best scrap rates wadala, scrap collection wadala" />
