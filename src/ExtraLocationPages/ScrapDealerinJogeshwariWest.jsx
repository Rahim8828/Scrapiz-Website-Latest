...
const ScrapDealerinJogeshwariWest = ({ openModal }) => {
  const locationData = {
    ...
    address: 'Shop No. 07, Jogeshwari West, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-jogeshwari-west#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-jogeshwari-west#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-jogeshwari-west#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Jogeshwari West",
            "item": "https://www.scrapiz.in/scrap-dealer-in-jogeshwari-west"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer jogeshwari west, scrap buyer jogeshwari west, kabadiwala jogeshwari west, sell scrap jogeshwari west, scrap pickup jogeshwari west, jogeshwari west scrap dealer, best scrap rates jogeshwari west, scrap collection jogeshwari west" />
