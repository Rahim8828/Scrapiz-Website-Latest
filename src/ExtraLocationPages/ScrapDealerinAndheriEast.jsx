...
const ScrapDealerinAndheriEast = ({ openModal }) => {
  const locationData = {
    name: 'Andheri East',
    address: 'Shop No. 07, Andheri East, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-andheri-east#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-andheri-east#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-andheri-east#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Andheri East",
            "item": "https://www.scrapiz.in/scrap-dealer-in-andheri-east"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer andheri east, scrap buyer andheri east, kabadiwala andheri east, sell scrap andheri east, scrap pickup andheri east, andheri east scrap dealer, best scrap rates andheri east, scrap collection andheri east" />
