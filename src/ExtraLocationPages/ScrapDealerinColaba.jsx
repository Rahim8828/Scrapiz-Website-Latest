...
const ScrapDealerinColaba = ({ openModal }) => {
  const locationData = {
    name: 'Colaba',
    address: 'Shop No. 07, Colaba, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-colaba#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-colaba#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-colaba#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Colaba",
            "item": "https://www.scrapiz.in/scrap-dealer-in-colaba"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer colaba, scrap buyer colaba, kabadiwala colaba, sell scrap colaba, scrap pickup colaba, colaba scrap dealer, best scrap rates colaba, scrap collection colaba" />
