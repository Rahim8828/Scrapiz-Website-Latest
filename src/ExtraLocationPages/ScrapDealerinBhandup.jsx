...
const ScrapDealerinBhandup = ({ openModal }) => {
  const locationData = {
    name: 'Bhandup',
    address: 'Shop No. 07, Bhandup, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-bhandup#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-bhandup#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-bhandup#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Bhandup",
            "item": "https://www.scrapiz.in/scrap-dealer-in-bhandup"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer bhandup, scrap buyer bhandup, kabadiwala bhandup, sell scrap bhandup, scrap pickup bhandup, bhandup scrap dealer, best scrap rates bhandup, scrap collection bhandup" />
