...
const ScrapDealerinGoregaonEast = ({ openModal }) => {
  const locationData = {
    name: 'Goregaon East',
    address: 'Shop No. 07, Goregaon East, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-goregaon-east#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-goregaon-east#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-goregaon-east#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Goregaon East",
            "item": "https://www.scrapiz.in/scrap-dealer-in-goregaon-east"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer goregaon east, scrap buyer goregaon east, kabadiwala goregaon east, sell scrap goregaon east, scrap pickup goregaon east, goregaon east scrap dealer, best scrap rates goregaon east, scrap collection goregaon east" />
