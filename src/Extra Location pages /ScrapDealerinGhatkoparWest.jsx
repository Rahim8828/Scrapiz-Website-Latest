...
const ScrapDealerinGhatkoparWest = ({ openModal }) => {
  const locationData = {
    name: 'Ghatkopar West',
    address: 'Shop No. 07, Ghatkopar West, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-ghatkopar-west#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-ghatkopar-west#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-ghatkopar-west#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Ghatkopar West",
            "item": "https://www.scrapiz.in/scrap-dealer-in-ghatkopar-west"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer ghatkopar west, scrap buyer ghatkopar west, kabadiwala ghatkopar west, sell scrap ghatkopar west, scrap pickup ghatkopar west, ghatkopar west scrap dealer, best scrap rates ghatkopar west, scrap collection ghatkopar west" />
