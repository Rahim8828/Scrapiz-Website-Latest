...
const ScrapDealerinKandivaliWest = ({ openModal }) => {
  const locationData = {
    name: 'Kandivali West',
    address: 'Shop No. 07, Kandivali West, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-kandivali-west#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-kandivali-west#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-kandivali-west#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Kandivali West",
            "item": "https://www.scrapiz.in/scrap-dealer-in-kandivali-west"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer kandivali west, scrap buyer kandivali west, kabadiwala kandivali west, sell scrap kandivali west, scrap pickup kandivali west, kandivali west scrap dealer, best scrap rates kandivali west, scrap collection kandivali west" />
