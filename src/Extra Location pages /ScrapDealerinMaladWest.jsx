...
const ScrapDealerinMaladWest = ({ openModal }) => {
  const locationData = {
    name: 'Malad West',
    address: 'Shop No. 07, Malad West, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-malad-west#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-malad-west#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-malad-west#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Malad West",
            "item": "https://www.scrapiz.in/scrap-dealer-in-malad-west"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer malad west, scrap buyer malad west, kabadiwala malad west, sell scrap malad west, scrap pickup malad west, malad west scrap dealer, best scrap rates malad west, scrap collection malad west" />
