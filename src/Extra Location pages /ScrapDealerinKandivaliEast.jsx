...
const ScrapDealerinKandivaliEast = ({ openModal }) => {
  const locationData = {
    name: 'Kandivali East',
    address: 'Shop No. 07, Kandivali East, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-kandivali-east#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-kandivali-east#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-kandivali-east#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Kandivali East",
            "item": "https://www.scrapiz.in/scrap-dealer-in-kandivali-east"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer kandivali east, scrap buyer kandivali east, kabadiwala kandivali east, sell scrap kandivali east, scrap pickup kandivali east, kandivali east scrap dealer, best scrap rates kandivali east, scrap collection kandivali east" />
