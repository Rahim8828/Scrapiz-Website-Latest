...
const ScrapDealerinByculla = ({ openModal }) => {
  const locationData = {
    name: 'Byculla',
    address: 'Shop No. 07, Byculla, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-byculla#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-byculla#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-byculla#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Byculla",
            "item": "https://www.scrapiz.in/scrap-dealer-in-byculla"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer byculla, scrap buyer byculla, kabadiwala byculla, sell scrap byculla, scrap pickup byculla, byculla scrap dealer, best scrap rates byculla, scrap collection byculla" />
