...
const ScrapDealerinGrantRoad = ({ openModal }) => {
  const locationData = {
    name: 'Grant Road',
    address: 'Shop No. 07, Grant Road, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-grant-road#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-grant-road#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-grant-road#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Grant Road",
            "item": "https://www.scrapiz.in/scrap-dealer-in-grant-road"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer grant road, scrap buyer grant road, kabadiwala grant road, sell scrap grant road, scrap pickup grant road, grant road scrap dealer, best scrap rates grant road, scrap collection grant road" />
