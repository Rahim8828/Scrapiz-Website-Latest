...
const ScrapDealerinDadarEast = ({ openModal }) => {
  const locationData = {
    name: 'Dadar East',
    address: 'Shop No. 07, Dadar East, Mumbai',
  ...
  const schemaMarkup = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-dadar-east#business",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-dadar-east#faq",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.scrapiz.in/scrap-dealer-in-dadar-east#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Dadar East",
            "item": "https://www.scrapiz.in/scrap-dealer-in-dadar-east"
          }
        ]
      }
    ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="scrap dealer dadar east, scrap buyer dadar east, kabadiwala dadar east, sell scrap dadar east, scrap pickup dadar east, dadar east scrap dealer, best scrap rates dadar east, scrap collection dadar east" />
